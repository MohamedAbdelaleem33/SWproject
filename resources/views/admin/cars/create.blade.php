...
<div class="role justify-content-center">
    <div class="col-lg-10">
        ...
        <div class="card">
            ...
            <div class="card-body">
                <form class="forms-sample" action="/admin/cars/add" enctype="multipart/form-data"
                    method="POST">
                    @csrf
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" name="plate_id" class="form-control @error('plate_id') is-invalid @enderror"
                                    placeholder="Plate Id" value="{{old('plate_id')}}">
                                @error('plate_id')
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" name="model"
                                    class="form-control @error('model') is-invalid @enderror" placeholder="model" value="{{old('model')}}">
                                @error('model')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            ...
                            <select class="form-control" name="officeNo" value="{{old('officeNo')}}">
                                <option value="" disabled selected>Please select</option>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" name="gas_type"
                                    class="form-control @error('gas_type') is-invalid @enderror" placeholder="gas type" value="{{old('gas_type')}}">
                                @error('gas_type')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" name="fuel_consumption"
                                    ...
                                    placeholder="fuel consumption" value="{{old('fuel_consumption')}}">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            ...
                            <select class="form-control" name="air_conditioning" value="{{old('air_conditioning')}}">
                                <option value="" disabled selected>Please select</option>
                        ...
                        <div class="col-md-6">
                            ...
                            <select class="form-control" name="bluetooth" value="{{old('bluetooth')}}">
                                <option value="" disabled selected>Please select</option>
                                <option value="1"> True </option>
                                <option value="0"> False </option>
                            </select>
