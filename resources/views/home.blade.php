...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-12">
            <div class="card">
                <div class="card-header">{{ __('Find Your Room') }}</div>
                ...
                <div class="card-body">
                    ...
                    <form method="GET" action="/rooms" enctype="multipart/form-data">
                    @else
                    ...
                    @endif
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col">
                            <input type="text" id="myInput1" class="myInput @error('location') is-invalid @enderror" onkeyup="dropdown1()" placeholder="Search.." name="location"  autocomplete="off">
                                @error('location')
